...
public class MySqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    private MySqlSessionFactoryBuilder sqlSessionFactoryBuilder = new MySqlSessionFactoryBuilder();
    ...
    /**
     * Sets the {@code MySqlSessionFactoryBuilder} to use when creating the {@code SqlSessionFactory}.
     * <p>
     * This is mainly meant for testing so that mock SqlSessionFactory classes can be injected. By
     * default, {@code MySqlSessionFactoryBuilder} creates {@code DefaultSqlSessionFactory} instances.
     */
    public void setMySqlSessionFactoryBuilder(MySqlSessionFactoryBuilder sqlSessionFactoryBuilder) {
     ...
     * {@code MySqlSessionFactoryBean.class.getSimpleName()}.
     *
...
/*                if (LOGGER.isDebugEnabled()) {
        ...
        LOGGER.info("buildSqlSessionFactory_finish!elapsed={}ms;this.sqlSessionFactoryBuilder={};sqlSessionFactory={};", (System.currentTimeMillis() - start), this.sqlSessionFactoryBuilder, sqlSessionFactory);
        return sqlSessionFactory;
    }
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        LOGGER.info("event={};failFast={};", event, failFast);
