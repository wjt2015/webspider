...
public interface MyMultiKeyBinaryCommands {
    Long del(byte[]... keys);
    ...
    void subscribe(MyBinaryJedisPubSub jedisPubSub, byte[]... channels);

    void psubscribe(MyBinaryJedisPubSub jedisPubSub, byte[]... patterns);
