...
public abstract class MyJedisPubSub {
    private int subscribedChannels = 0;
    private volatile MyClient client;
    ...
    public void proceedWithPatterns(MyClient client, String... patterns) {
        this.client = client;
        client.psubscribe(patterns);
        client.flush();
        process(client);
    ...
    public void proceed(MyClient client, String... channels) {
        this.client = client;
        client.subscribe(channels);
        client.flush();
        process(client);
    ...
    private void process(MyClient client) {
