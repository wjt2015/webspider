...
@Slf4j
public class MyPipeline extends MyMultiKeyPipelineBase implements Closeable {
    ...
    private class MultiResponseBuilder extends Builder<List<Object>> {
        ...
        public List<Object> build(Object data) {
            ...
            log.info("data={};responses={};", data, responses);
    ...
    protected <T> Response<T> getResponse(Builder<T> builder) {
        ...
        log.info("currentMulti={};builder={};", currentMulti, builder);
    ...
    public List<Object> syncAndReturnAll() {
        if (getPipelinedResponseLength() > 0) {
            ...
            log.info("unformatted={};formatted={};", unformatted, formatted);
