...
public class MyClient extends MyBinaryClient implements MyCommands {

    public MyClient() {
        super();
    }

    public MyClient(final String host) {
        super(host);
    }
    ...
    public MyClient(final String host, final int port, final boolean ssl) {
        super(host, port, ssl);
    }
