...
public class MyBinaryClient extends MyConnection {
    ...
    public MyBinaryClient() {
        super();
    }

    public MyBinaryClient(final String host) {
        super(host);
    }

    public MyBinaryClient(final String host, final int port) {
        super(host, port);
    }

    public MyBinaryClient(final String host, final int port, final boolean ssl) {
        super(host, port, ssl);
    }
