...
public abstract class MyBinaryJedisPubSub {
    ...
    public void proceedWithPatterns(MyClient client, byte[]... patterns) {
        this.client = client;
        client.psubscribe(patterns);
        client.flush();
        process(client);
    ...
    public void proceed(MyClient client, byte[]... channels) {
        this.client = client;
        client.subscribe(channels);
        client.flush();
        process(client);
