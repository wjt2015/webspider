...
@Slf4j
public abstract class MyPool<T> implements Closeable {
    protected MyGenericObjectPool<T> internalPool;
    ...
    public MyPool(final GenericObjectPoolConfig poolConfig, PooledObjectFactory<T> factory) {
    ...
    public void initPool(final GenericObjectPoolConfig poolConfig, PooledObjectFactory<T> factory) {
        ...
        this.internalPool = new MyGenericObjectPool<T>(factory, poolConfig);
    }
